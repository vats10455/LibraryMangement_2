...
public class dashboard1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            ...
            case R.id.studentrecord:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new studentrecord1()).commit();
                break;
            ...
            case R.id.changepassword:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new change_password1()).commit();
                break;
            case R.id.logout:
                logout();
                break;
    ...
    public void logout(){
        ...
        finish();
        Intent studentRecordIntent = new Intent(dashboard1.this, MainActivity.class);
        dashboard1.this.startActivity(studentRecordIntent);
    }
    @Override
