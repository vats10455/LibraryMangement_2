...
public class change_password1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.change_password1, container, false);
    ...
    private void change() {
        ...
        stop = 1;
        getFragmentManager().beginTransaction().replace(R.id.fragment_container, new change_password1()).commit();
    }
